      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {selectedRoleTags.length > 0 && (
              <button
                ...
                className="px-3 py-2 rounded-lg text-sm font-medium bg-red-600 hover:bg-red-700 text-white"
              >
                Clear All
              </button>
            )}
        ...
        <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-900 rounded-lg p-4">
            ...
            <p className="text-2xl text-yellow-400">{preparatoryUsers.length}</p>
          </div>
          <div className="bg-gray-900 rounded-lg p-4">
            <h3 className="text-lg font-semibold mb-2">Total</h3>
            <p className="text-2xl text-green-400">{filteredRegisteredUsers.length + preparatoryUsers.length}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {filteredRegisteredUsers.map(user => (
            <a 
              ...
              className="bg-gray-900 rounded-lg p-6 border-l-4 border-green-500 hover:bg-gray-800 transition-colors duration-200 cursor-pointer block"
            >
          ...
          {/* Preparatory Users */}
          {preparatoryUsers.map(prepUser => (
            <div key={`prep-${prepUser.id}`} className="bg-gray-900 rounded-lg p-6 border-l-4 border-yellow-500">
              <div className="flex items-center mb-4">
        ...
        {/* Empty State */}
        {filteredRegisteredUsers.length === 0 && preparatoryUsers.length === 0 && (
